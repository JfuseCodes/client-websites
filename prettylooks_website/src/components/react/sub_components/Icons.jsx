...
export const CancelIcon = () => {
    return (
        <svg className='fill-black' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
...
export const FaceBookIcon = ({width, height}) => {
    return (
        <svg className={`${width} ${height}`} viewBox="0 0 128 128" >
